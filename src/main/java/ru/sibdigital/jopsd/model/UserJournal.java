...
@Table(name = "user_journals", indexes = {
        @Index(name = "index_user_journals_on_journal_id", columnList = "journal_id")
})
@Entity
public class UserJournal {
    ...
    @Column(name = "phone_wrk", length = 14)
    private String phoneWrk;

    @Column(name = "phone_wrk_add", length = 6)
    private String phoneWrkAdd;

    @Column(name = "phone_mobile", length = 12)
    private String phoneMobile;

    @Column(name = "mail_add", length = 60)
