...
@Slf4j
@Component
public class MemberMeetingsOverdue implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            botService.processMeetingsMemberOverdue(settingService.getUrlRequestBrbo(), jsonRequest);

        } catch (Exception e) {
            botLogger.error("ERROR at MemberMeetingsOverdue: ", e);
        }
    }
